            ...
            <table class="table giohang" style="width: 100%; text-align: center;" border="1">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?quanly=xuatkhosanpham&tru=<?php echo $cart_item['id'] ?>"><i
                                    class="fa-solid fa-square-minus"></i></a>
                            <?php echo $cart_item['soluong']; ?>
                            <a href="index.php?quanly=xuatkhosanpham&cong=<?php echo $cart_item['id'] ?>"><i
                                    class="fa-solid fa-square-plus"></i></a>
                        </td>

                        <td><a class="btn btn-danger"
                                href="index.php?quanly=xuatkhosanpham&xoa=<?php echo $cart_item['id'] ?>">Xóa</a></td>
                    </tr>
                    <?php
                        }
                ?>
                    <tr>
                        <td colspan="8">
                            <p style="float: right;"><a class="btn btn-info"
                                    href="index.php?quanly=xuatkhosanpham&xoatatca=1">Xóa tất cả</a></p>
